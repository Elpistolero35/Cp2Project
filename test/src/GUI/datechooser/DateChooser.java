...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new GUI.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new GUI.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new GUI.datechooser.Button();
        cmdPrevious = new GUI.datechooser.Button();
        slide = new GUI.datechooser.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/datechooser/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/datechooser/previous.png"))); // NOI18N
    ...
    private GUI.datechooser.Button cmdForward;
    private GUI.datechooser.Button cmdMonth;
    private GUI.datechooser.Button cmdPrevious;
    private GUI.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private GUI.datechooser.Slider slide;
