...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new GUI.datechooser.Button();
        cmdTu = new GUI.datechooser.Button();
        cmdWe = new GUI.datechooser.Button();
        cmdTh = new GUI.datechooser.Button();
        cmdFr = new GUI.datechooser.Button();
        cmdSa = new GUI.datechooser.Button();
        cmdSu = new GUI.datechooser.Button();
        cmd1 = new GUI.datechooser.Button();
        cmd2 = new GUI.datechooser.Button();
        cmd3 = new GUI.datechooser.Button();
        cmd4 = new GUI.datechooser.Button();
        cmd5 = new GUI.datechooser.Button();
        cmd6 = new GUI.datechooser.Button();
        cmd7 = new GUI.datechooser.Button();
        cmd8 = new GUI.datechooser.Button();
        cmd9 = new GUI.datechooser.Button();
        cmd10 = new GUI.datechooser.Button();
        cmd11 = new GUI.datechooser.Button();
        cmd12 = new GUI.datechooser.Button();
        cmd13 = new GUI.datechooser.Button();
        cmd14 = new GUI.datechooser.Button();
        cmd15 = new GUI.datechooser.Button();
        cmd16 = new GUI.datechooser.Button();
        cmd17 = new GUI.datechooser.Button();
        cmd18 = new GUI.datechooser.Button();
        cmd19 = new GUI.datechooser.Button();
        cmd20 = new GUI.datechooser.Button();
        cmd21 = new GUI.datechooser.Button();
        cmd22 = new GUI.datechooser.Button();
        cmd23 = new GUI.datechooser.Button();
        cmd24 = new GUI.datechooser.Button();
        cmd25 = new GUI.datechooser.Button();
        cmd26 = new GUI.datechooser.Button();
        cmd27 = new GUI.datechooser.Button();
        cmd28 = new GUI.datechooser.Button();
        cmd29 = new GUI.datechooser.Button();
        cmd30 = new GUI.datechooser.Button();
        cmd31 = new GUI.datechooser.Button();
        cmd32 = new GUI.datechooser.Button();
        cmd33 = new GUI.datechooser.Button();
        cmd34 = new GUI.datechooser.Button();
        cmd35 = new GUI.datechooser.Button();
        cmd36 = new GUI.datechooser.Button();
        cmd37 = new GUI.datechooser.Button();
        cmd38 = new GUI.datechooser.Button();
        cmd39 = new GUI.datechooser.Button();
        cmd40 = new GUI.datechooser.Button();
        cmd41 = new GUI.datechooser.Button();
        cmd42 = new GUI.datechooser.Button();
    ...
    private GUI.datechooser.Button cmd1;
    private GUI.datechooser.Button cmd10;
    private GUI.datechooser.Button cmd11;
    private GUI.datechooser.Button cmd12;
    private GUI.datechooser.Button cmd13;
    private GUI.datechooser.Button cmd14;
    private GUI.datechooser.Button cmd15;
    private GUI.datechooser.Button cmd16;
    private GUI.datechooser.Button cmd17;
    private GUI.datechooser.Button cmd18;
    private GUI.datechooser.Button cmd19;
    private GUI.datechooser.Button cmd2;
    private GUI.datechooser.Button cmd20;
    private GUI.datechooser.Button cmd21;
    private GUI.datechooser.Button cmd22;
    private GUI.datechooser.Button cmd23;
    private GUI.datechooser.Button cmd24;
    private GUI.datechooser.Button cmd25;
    private GUI.datechooser.Button cmd26;
    private GUI.datechooser.Button cmd27;
    private GUI.datechooser.Button cmd28;
    private GUI.datechooser.Button cmd29;
    private GUI.datechooser.Button cmd3;
    private GUI.datechooser.Button cmd30;
    private GUI.datechooser.Button cmd31;
    private GUI.datechooser.Button cmd32;
    private GUI.datechooser.Button cmd33;
    private GUI.datechooser.Button cmd34;
    private GUI.datechooser.Button cmd35;
    private GUI.datechooser.Button cmd36;
    private GUI.datechooser.Button cmd37;
    private GUI.datechooser.Button cmd38;
    private GUI.datechooser.Button cmd39;
    private GUI.datechooser.Button cmd4;
    private GUI.datechooser.Button cmd40;
    private GUI.datechooser.Button cmd41;
    private GUI.datechooser.Button cmd42;
    private GUI.datechooser.Button cmd5;
    private GUI.datechooser.Button cmd6;
    private GUI.datechooser.Button cmd7;
    private GUI.datechooser.Button cmd8;
    private GUI.datechooser.Button cmd9;
    private GUI.datechooser.Button cmdFr;
    private GUI.datechooser.Button cmdMo;
    private GUI.datechooser.Button cmdSa;
    private GUI.datechooser.Button cmdSu;
    private GUI.datechooser.Button cmdTh;
    private GUI.datechooser.Button cmdTu;
    private GUI.datechooser.Button cmdWe;
