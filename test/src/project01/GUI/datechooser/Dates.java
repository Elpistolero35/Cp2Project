...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new project01.GUI.datechooser.Button();
        cmdTu = new project01.GUI.datechooser.Button();
        cmdWe = new project01.GUI.datechooser.Button();
        cmdTh = new project01.GUI.datechooser.Button();
        cmdFr = new project01.GUI.datechooser.Button();
        cmdSa = new project01.GUI.datechooser.Button();
        cmdSu = new project01.GUI.datechooser.Button();
        cmd1 = new project01.GUI.datechooser.Button();
        cmd2 = new project01.GUI.datechooser.Button();
        cmd3 = new project01.GUI.datechooser.Button();
        cmd4 = new project01.GUI.datechooser.Button();
        cmd5 = new project01.GUI.datechooser.Button();
        cmd6 = new project01.GUI.datechooser.Button();
        cmd7 = new project01.GUI.datechooser.Button();
        cmd8 = new project01.GUI.datechooser.Button();
        cmd9 = new project01.GUI.datechooser.Button();
        cmd10 = new project01.GUI.datechooser.Button();
        cmd11 = new project01.GUI.datechooser.Button();
        cmd12 = new project01.GUI.datechooser.Button();
        cmd13 = new project01.GUI.datechooser.Button();
        cmd14 = new project01.GUI.datechooser.Button();
        cmd15 = new project01.GUI.datechooser.Button();
        cmd16 = new project01.GUI.datechooser.Button();
        cmd17 = new project01.GUI.datechooser.Button();
        cmd18 = new project01.GUI.datechooser.Button();
        cmd19 = new project01.GUI.datechooser.Button();
        cmd20 = new project01.GUI.datechooser.Button();
        cmd21 = new project01.GUI.datechooser.Button();
        cmd22 = new project01.GUI.datechooser.Button();
        cmd23 = new project01.GUI.datechooser.Button();
        cmd24 = new project01.GUI.datechooser.Button();
        cmd25 = new project01.GUI.datechooser.Button();
        cmd26 = new project01.GUI.datechooser.Button();
        cmd27 = new project01.GUI.datechooser.Button();
        cmd28 = new project01.GUI.datechooser.Button();
        cmd29 = new project01.GUI.datechooser.Button();
        cmd30 = new project01.GUI.datechooser.Button();
        cmd31 = new project01.GUI.datechooser.Button();
        cmd32 = new project01.GUI.datechooser.Button();
        cmd33 = new project01.GUI.datechooser.Button();
        cmd34 = new project01.GUI.datechooser.Button();
        cmd35 = new project01.GUI.datechooser.Button();
        cmd36 = new project01.GUI.datechooser.Button();
        cmd37 = new project01.GUI.datechooser.Button();
        cmd38 = new project01.GUI.datechooser.Button();
        cmd39 = new project01.GUI.datechooser.Button();
        cmd40 = new project01.GUI.datechooser.Button();
        cmd41 = new project01.GUI.datechooser.Button();
        cmd42 = new project01.GUI.datechooser.Button();
    ...
    private project01.GUI.datechooser.Button cmd1;
    private project01.GUI.datechooser.Button cmd10;
    private project01.GUI.datechooser.Button cmd11;
    private project01.GUI.datechooser.Button cmd12;
    private project01.GUI.datechooser.Button cmd13;
    private project01.GUI.datechooser.Button cmd14;
    private project01.GUI.datechooser.Button cmd15;
    private project01.GUI.datechooser.Button cmd16;
    private project01.GUI.datechooser.Button cmd17;
    private project01.GUI.datechooser.Button cmd18;
    private project01.GUI.datechooser.Button cmd19;
    private project01.GUI.datechooser.Button cmd2;
    private project01.GUI.datechooser.Button cmd20;
    private project01.GUI.datechooser.Button cmd21;
    private project01.GUI.datechooser.Button cmd22;
    private project01.GUI.datechooser.Button cmd23;
    private project01.GUI.datechooser.Button cmd24;
    private project01.GUI.datechooser.Button cmd25;
    private project01.GUI.datechooser.Button cmd26;
    private project01.GUI.datechooser.Button cmd27;
    private project01.GUI.datechooser.Button cmd28;
    private project01.GUI.datechooser.Button cmd29;
    private project01.GUI.datechooser.Button cmd3;
    private project01.GUI.datechooser.Button cmd30;
    private project01.GUI.datechooser.Button cmd31;
    private project01.GUI.datechooser.Button cmd32;
    private project01.GUI.datechooser.Button cmd33;
    private project01.GUI.datechooser.Button cmd34;
    private project01.GUI.datechooser.Button cmd35;
    private project01.GUI.datechooser.Button cmd36;
    private project01.GUI.datechooser.Button cmd37;
    private project01.GUI.datechooser.Button cmd38;
    private project01.GUI.datechooser.Button cmd39;
    private project01.GUI.datechooser.Button cmd4;
    private project01.GUI.datechooser.Button cmd40;
    private project01.GUI.datechooser.Button cmd41;
    private project01.GUI.datechooser.Button cmd42;
    private project01.GUI.datechooser.Button cmd5;
    private project01.GUI.datechooser.Button cmd6;
    private project01.GUI.datechooser.Button cmd7;
    private project01.GUI.datechooser.Button cmd8;
    private project01.GUI.datechooser.Button cmd9;
    private project01.GUI.datechooser.Button cmdFr;
    private project01.GUI.datechooser.Button cmdMo;
    private project01.GUI.datechooser.Button cmdSa;
    private project01.GUI.datechooser.Button cmdSu;
    private project01.GUI.datechooser.Button cmdTh;
    private project01.GUI.datechooser.Button cmdTu;
    private project01.GUI.datechooser.Button cmdWe;
